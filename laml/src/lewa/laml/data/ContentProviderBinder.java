...
import lewa.laml.elements.ImageScreenElement;
import lewa.laml.elements.ListScreenElement;
import lewa.laml.elements.ListScreenElement.ColumnInfo;
import lewa.laml.elements.ListScreenElement.DataWrapper;
import lewa.laml.elements.ListScreenElement.DeleteExtra;
    ...
    private boolean updateVariables() {
        synchronized (mCursorLock) {
            ...
            if (mCursor == null || (count = mCursor.getCount()) == 0) {
                ...
                for (lewa.laml.data.VariableBinder.Variable v : mVariables) {
