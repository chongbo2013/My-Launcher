...
class LauncherSettings {
    ...
    static final class Screens implements BaseLauncherColumns {
        /**
         * The content:// style URL for this table
         */
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_SCREENS);
    }
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        */
        ...
        // Begin, added by zhumeiquan for hiding Apps
        /**
         * Indicates whether this favorite is hidden or not, 1 for hidden , 0 for not
         * <P>Type: INTEGER</P>
         */
    ...
    static final class RecommendApps implements BaseLauncherColumns {
        /**
         * The content:// style URL for this table
         */
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_RECOMMEND);
    ...
    static final class AppCategory implements BaseLauncherColumns {
        static final Uri CONTENT_URI = Uri.parse("content://" +
    ...
    static final class CategoryMap implements BaseLauncherColumns {
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_CATEGORY_MAP);
        /**
         * The id of folder show recommend
         */
        static final String FOLDER_ID = "folderId";
        /**
         * The folder category name
         */
        static final String CATEGORY = "category";
        /**
         * The category id get from server
         */
        static final String CATEGORY_ID ="categoryId";
        /**
         * The category url in app store
         */
